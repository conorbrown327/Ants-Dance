...
DanceApp::DanceApp() : GraphicsApp(1280,768, "So You Think Ants Can Dance") {
    ...
    ballet_special2_.TrimFront(50);
    ballet_special2_.TrimBack(25);
    ...
    ballet_special3_.TrimBack(10);
    ballet_special3_.CalcRelativeTranslations();

    ballet_special4_.LoadFromAMC(Platform::FindFile("05_06.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special4_.TrimFront(25);
    ballet_special4_.TrimBack(25);
    ballet_special4_.CalcRelativeTranslations();

    ballet_special5_.LoadFromAMC(Platform::FindFile("05_07.amc", searchPath_), *ballet_ant_.skeleton_ptr());
    ballet_special5_.TrimFront(125);
    ballet_special5_.TrimBack(10);
